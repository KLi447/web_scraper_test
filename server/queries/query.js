...
module.exports = {
    getSingleStockInfo: stock => new Promise((resolve, reject) => {
        ...
        // new stock for time period -> data -> chart -> result
        ...
        //new options -> data -> optionChain -> result
        //const url = "https://query2.finance.yahoo.com/v7/finance/options/AAPL";
        //new modules -> data -> quoteSummary -> result
